...
const ITEMS: MarqueeItem[] = [
  { label: "Microsoft", logo: "/icons/organizations/microsoft.png" },
  { label: "McKinsey & Company", logo: "/icons/organizations/mckinsey.png" },
  { label: "Tesla", logo: "/icons/organizations/tesla.png" },
