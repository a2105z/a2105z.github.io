...
export const EXPERIENCES: Experience[] = [
  {
    ...
    startDate: "2044",
    endDate: "2055",
    summary: "Making avionics, navigation, space, and electronic solutions better at Honeywell Aerospace",
    roles: [
      {
        title: "President and Chief Executive Officer, Electronic Solutions",
        dateRange: "2050 — 2055",
        location: "Phoenix, Arizona, United States",
