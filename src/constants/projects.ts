...
export const EXPERIENCES: Experience[] = [
  ...
  },
  {
    ...
    endDate: "May 2028",
    summary:
      "Building real-time recommendation systems that personalize Capital One’s consumer digital experiences",
    groupIcon: "🎯",
    employmentType: "Internship",
    roles: [
      {
        title: "Software Engineering Intern, APEX Recommendation",
